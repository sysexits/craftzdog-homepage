...
function PubSubPage({delay}) {
    return (
        ...
        <PubSection>
        Jaehyun Jang, William Frier, Orestis Georgiou, and Jinah Park, <i>&quot;Using Mid-air Tactile Patterns in Interactive Volume Exploration,&quot;</i> presented at the IEEE World Haptics 2021.
    (Hands-on Demo) <Link href='/works/hologram'>[Work]</Link>
        ...
        <PubSection>
        Jaehyun Jang and Jinah Park, <i>&quot;Interacting with Fluids using Ultrasonic Mid-Air Haptic Device,&quot;</i> presented at the IEEE World Haptics Conference 2021. (Hands-on
    Demo)
        </PubSection>
        <PubYear>
        ...
        <PubSection>
        Jaehyun Jang, Joowon Lim, and Jinah Park, <i>&quot;Real-time volume exploration technique for holographic display,&quot;</i> in International Forum on Medical Imaging in Asia 2021,
    ...
    Mid-Air Haptics,&quot;</i> IEEE Transactions on Haptics, Jan. 2020 <Link href='/works/sph_fluid'>[Work]</Link> <Link href="https://ieeexplore.ieee.org/document/8959191/" target="_blank">[Paper]</Link> <Link href="https://www.youtube.com/watch?v=hCRA5dIRS3I" target="_blank">[Presentation]</Link>
        ...
        <PubSection>
        Jaehyun Jang, Jinah Park, <i>&quot;Virtual Faucet: Stream Or Spray,&quot;</i> presented at the IEEE World Haptics Conference 2019, Jul. 2019. (Hands-on Demo) <Link href="https://www.youtube.com/watch?v=UFgp7A1IK7o&t=229s" target="_blank">[Movie]</Link>
        </PubSection>
